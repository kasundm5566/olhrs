...
<table class="table-bordered" style="width: 100%;">
    ...
    $sql = "SELECT * FROM reservation r,hall_reservation hr, customer c, hall h "
            ...
            . "AND monthname(reservation_date)='$month';";
...
<div style="padding-top: 10px; display: inline-block;">
    <a href="all-hall-report-print.php?year=<?php echo $year; ?>&month=<?php echo $month; ?>&hall=All Halls" target="_blank" class="btn btn-success btn-xs">Print PDF</a>
</div>
<div style="padding-top: 10px; display: inline-block;">
    <a href="all-hall-chart.php?year=<?php echo $year; ?>&month=<?php echo $month; ?>" target="_blank" class="btn btn-success btn-xs">View chart</a>
</div>