...
<table class="table-bordered table-condensed" style="width: 100%;">
    <caption style="font-size: medium;">Monthly Reservations Report for Queens Hall A</caption>
    <thead>
        <tr>
    ...
    $sql = "SELECT * FROM reservation r,hall_reservation hr, customer c, hall h "
            ...
            . "AND monthname(reservation_date)='$month' AND hall_name='Queens Hall A';";
...
<div style="padding-top: 10px; display: inline-block;">
    <a href="queensa-hall-report-print.php?year=<?php echo $year; ?>&month=<?php echo $month; ?>&hall=Queens Hall A" target="_blank" class="btn btn-success btn-xs">Print PDF</a>
</div>
<?php
$total = 0;
