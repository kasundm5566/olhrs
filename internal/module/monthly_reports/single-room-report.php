...
<table class="table-bordered table-condensed" style="width: 100%;">
    <caption style="font-size: medium;">Monthly Reservations Report for Single Rooms</caption>
    <thead>
        <tr>
    ...
    $sql = "SELECT * FROM reservation r,room_reservation rr, customer c, room_type rt "
            ...
            . "monthname(check_in)='$month' AND room_type_name='Single';";
...
<div style="padding-top: 10px; display: inline-block;">
    <a href="single-room-report-print.php?year=<?php echo $year; ?>&month=<?php echo $month; ?>&room=Single Room" target="_blank" class="btn btn-success btn-xs">Print PDF</a>
</div>
<?php
$total = 0;
