...
<table class="table-bordered table-condensed" style="width: 100%;">
    <caption style="font-size: medium;">Yearly Reservations Report for Family Rooms</caption>
    <thead>
        <tr>
...
<div style="padding-top: 10px;">
    <a href="family-room-report-print.php?year=<?php echo $year; ?>&room=Family Rooms" target="_blank" class="btn btn-success btn-xs">Print PDF</a>
</div>
<?php
$total = 0;
