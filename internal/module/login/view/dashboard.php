                    ...
                    <div class="container dynamicTile" id="tile-block">
                        <div class="row">
                            <div class="col-sm-4 col-xs-8">
                                <a href="" data-toggle="tooltip" data-placement="bottom" title="Manage reservations related things.">
                                    <!-- Reservation tile -->
                        ...
                        <div class="row ">                       
                            <div class="col-sm-4 col-xs-8">
                                <a href="" data-toggle="tooltip" data-placement="bottom" title="Manage customer related things.">    
                                    <!-- Customer tile -->
